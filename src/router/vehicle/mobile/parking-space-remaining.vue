<template>
    <div class="view">
        <!-- 剩餘車位 -->
        <Header :title="`${$t('Remaining')}${$t('ParkingSpace')}`"/>
        <div class="p-remaining-parking-space">
            ...
            <div class="garages-container garages-container--mobile">
                <div v-for="(item, index) in data"
                    class="garages garages--mobile"
                    :class="{
                        'garages--full': item.isFull,
